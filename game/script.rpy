        ...
        "No, he’s not. He’s done so much for you, and yet you didn’t notice anything wrong until now?":
            ...
            menu:
                "That’s not true":
                    show N angry at even_more_lowered
                    $ p =+ 1
                    N "{size=+2}{cps=20}Not you being a {b}fucking{/b} liar too.{/cps}{/size}{w=1}{nw}"
...
#SCENE 4:
    ...
    menu:
        "Oh, Noah...":
            ...
            N "Just{w=0.8} {size=+4}{b}STOP{/b}{/size}."
            ...
            Weren’t you supposed to protect me from all this happening?{/b}{/size}{/sc}{w=2}{nw}"
            ...
            N "{sc=2}{size=+5}{cps=20}THIS IS {b}YOUR{/b} FAULT.{/cps}{/size}{/sc}{w=2}{nw}"
